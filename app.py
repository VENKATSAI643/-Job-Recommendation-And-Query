...
def submit_data():
    if request.method == 'POST':
        ...
        df2 = df1[['Title', 'OrganizationName', 'LocationLocality']].head(10).reset_index()
        df2['LocationLocality'] = df2['LocationLocality'].str.replace(r'[^\x00-\x7F]', '')   
        df2['LocationLocality'] = df2['LocationLocality'].str.replace("â€“", "")

        dropdown_locations = sorted(df2['LocationLocality'].unique())
